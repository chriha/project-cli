...
class TailCommand extends Command
{
    ...
    private function logFileInfo(string $file, int $size = null) : void
    {
        ...
        $this->info(
            "Your log file '{$file}' is getting big (" . round(
                ($size / 1000000),
                3
            ) . " MB). Consider clearing it for better performance."
        );
